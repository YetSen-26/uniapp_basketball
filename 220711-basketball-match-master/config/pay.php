...
return [
    'alipay' => [
        ...
        // 支付宝异步通知地址
        'notify_url' => 'http://tuiguang.fvfire.com/api/order/aliNotify',
    ...
    'wechat' => [
        ...
        'cert_client' => resource_path("keys/wechat/apiclient_cert.pem"),

        // 客户端秘钥路径，退款、红包等需要用到。请填写绝对路径，linux 请确保权限问题。pem 格式。
        'cert_key' => resource_path("keys/wechat/apiclient_key.pem"),
